...
#define AWS_IOT_MQTT_CLIENT_ID         "562b4838-a6f8-43d5-8f39-741c1b192dd6" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME          "demo-one" ///< Thing Name of the Shadow this device is associated with
