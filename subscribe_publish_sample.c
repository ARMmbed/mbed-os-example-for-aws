...
int subscribe_publish (void) {
	...
	mqttInitParams.pRootCALocation = (char *)AWS_RootCA;
	mqttInitParams.pDeviceCertLocation = (char *)AWS_ClientCert;
	mqttInitParams.pDevicePrivateKeyLocation = (char *)AWS_ClientPrivateKey;
	...
	while((NETWORK_ATTEMPTING_RECONNECT == rc || NETWORK_RECONNECTED == rc || SUCCESS == rc)
		...
		if(NETWORK_ATTEMPTING_RECONNECT == rc) {
            ...
            IOT_INFO("attempting to reconnect");
			continue;
		}
